...
// Input byte arrays shared by the tables below. A parenthesized type with an
// initializer list is a GCC/Clang extension that MSVC rejects, so they are
// named arrays instead.
// Never read: the matching ilen is 0
constexpr uint8_t b64_in_01[] = {0};
constexpr uint8_t b64_in_02[] = {0x00};                                // 1 bytes
constexpr uint8_t b64_in_03[] = {0x00, 0x00};                          // 2 bytes
constexpr uint8_t b64_in_04[] = {0x00, 0x00, 0x00};                    // 3 bytes
constexpr uint8_t b64_in_05[] = {0xFF};                                // 1 bytes
constexpr uint8_t b64_in_06[] = {0xFF, 0xFF};                          // 2 bytes
constexpr uint8_t b64_in_07[] = {0xFF, 0xFF, 0xFF};                    // 3 bytes
constexpr uint8_t b64_in_08[] = {0xDE, 0xAD, 0xBE, 0xEF};              // 4 bytes
constexpr uint8_t b64_in_09[] = {0x48, 0x65, 0x6C, 0x6C, 0x6F};        // 5 bytes
constexpr uint8_t b64_in_10[] = {0x4D, 0x61, 0x73, 0x74, 0x65, 0x72};  // 6 bytes
constexpr uint8_t b64_in_11[] = {0x00, 0x01, 0x02, 0x03, 0x04};        // 5 bytes
constexpr uint8_t b64_in_12[] = {0x7E, 0xBA, 0x90, 0x33, 0x8B};        // 5 bytes
constexpr uint8_t b64_in_13[] = {0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41,
                                 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41,
                                 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41,
                                 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41,
                                 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41};  // 63 bytes
constexpr uint8_t b64_in_14[] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};  // 48 bytes
constexpr uint8_t b64_in_15[] = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
                                 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
                                 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
                                 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
                                 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};  // 64 bytes
constexpr uint8_t b64_in_16[] = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C,
                                 0x0D, 0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19,
                                 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26,
                                 0x27, 0x28, 0x29, 0x2A, 0x2B, 0x2C, 0x2D, 0x2E, 0x2F, 0x30, 0x31, 0x32, 0x33,
                                 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x3A, 0x3B, 0x3C, 0x3D, 0x3E, 0x3F};  // 64 bytes
constexpr uint8_t b64_in_17[] = {0x41, 0x42, 0x43, 0x41, 0x42, 0x43, 0x41, 0x42, 0x43, 0x41, 0x42, 0x43, 0x41, 0x42,
                                 ...
                                 0x43, 0x41, 0x42, 0x43, 0x41, 0x42, 0x43, 0x41, 0x42, 0x43};  // 66 bytes
...
constexpr Base64TestData nolinebreak_std_padding_table[] = {
    ...
    {b64_in_06, 2, "//8=", 4},
    {b64_in_07, 3, "////", 4},
    {b64_in_08, 4, "3q2+7w==", 8},
    {b64_in_09, 5, "SGVsbG8=", 8},
    {b64_in_10, 6, "TWFzdGVy", 8},
    {b64_in_11, 5, "AAECAwQ=", 8},
    {b64_in_12, 5, "frqQM4s=", 8},
    {b64_in_13, 63, "QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB", 84},
    {b64_in_14, 48, "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", 64},
    {b64_in_15, 64, "/////////////////////////////////////////////////////////////////////////////////////w==", 88},
    {b64_in_16, 64, "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGxwdHh8gISIjJCUmJygpKissLS4vMDEyMzQ1Njc4OTo7PD0+Pw==", 88},
    {b64_in_17, 66, "QUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJD", 88},
};
...
constexpr Base64TestData nolinebreak_std_nopad_table[] = {
    ...
    {b64_in_06, 2, "//8", 3},
    {b64_in_07, 3, "////", 4},
    {b64_in_08, 4, "3q2+7w", 6},
    {b64_in_09, 5, "SGVsbG8", 7},
    {b64_in_10, 6, "TWFzdGVy", 8},
    {b64_in_11, 5, "AAECAwQ", 7},
    {b64_in_12, 5, "frqQM4s", 7},
    {b64_in_13, 63, "QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB", 84},
    {b64_in_14, 48, "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", 64},
    {b64_in_15, 64, "/////////////////////////////////////////////////////////////////////////////////////w", 86},
    {b64_in_16, 64, "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGxwdHh8gISIjJCUmJygpKissLS4vMDEyMzQ1Njc4OTo7PD0+Pw", 86},
    {b64_in_17, 66, "QUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJD", 88},
};
...
constexpr Base64TestData nolinebreak_url_padding_table[] = {
    ...
    {b64_in_13, 63, "QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB", 84},
    {b64_in_14, 48, "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", 64},
    {b64_in_15, 64, "_____________________________________________________________________________________w==", 88},
    {b64_in_16, 64, "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGxwdHh8gISIjJCUmJygpKissLS4vMDEyMzQ1Njc4OTo7PD0-Pw==", 88},
    {b64_in_17, 66, "QUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJD", 88},
};
...
constexpr Base64TestData nolinebreak_url_nopad_table[] = {
    ...
    {b64_in_13, 63, "QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB", 84},
    {b64_in_14, 48, "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", 64},
    {b64_in_15, 64, "_____________________________________________________________________________________w", 86},
    {b64_in_16, 64, "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGxwdHh8gISIjJCUmJygpKissLS4vMDEyMzQ1Njc4OTo7PD0-Pw", 86},
    {b64_in_17, 66, "QUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJDQUJD", 88},
};
