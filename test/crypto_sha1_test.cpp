...
TEST(Crypto_SHA1, Basic)
{
    ...
    constexpr uint8_t expected_million_a[20] = {
...
TEST(Crypto_SHA1, EdgeCases)
{
    ...
    // All same byte patterns
    {
        ...
        EXPECT_TRUE(memcmp(sha1_test_table[11].input,
...
TEST(Crypto_SHA1, NIST_CAVP_Long_Messages)
{
    ...
    // 56 bytes = 448 bits, leaves exactly 64 bits for padding+length
    {
        ...
        const uint8_t msg[] = {
            0x03, 0x21, 0x73, 0x6B, 0xEB, 0xA5, 0x78, 0xE9,
            0x0A, 0xBC, 0x1A, 0x90, 0xAA, 0x56, 0x15, 0x7D,
            0x87, 0x16, 0x18, 0xF6, 0xDE, 0x0D, 0x76, 0x4C,
            0xC8, 0xC9, 0x1E, 0x06, 0xC6, 0x8E, 0xCD, 0x3B,
            0x9D, 0xE3, 0x82, 0x40, 0x64, 0x50, 0x33, 0x84,
            0xDB, 0x67, 0xBE, 0xB7, 0xFE, 0x01, 0x22, 0x32,
            0xDA, 0xCA, 0xEF, 0x93, 0xA0, 0x00, 0xFB, 0xA7
        };
        const uint8_t expected[] = {
            0xAE, 0xF8, 0x43, 0xB8, 0x69, 0x16, 0xC1, 0x6F, 0x66, 0xC8,
    ...
    // 512-bit (64 bytes) - exactly one block
    {
        ...
        const uint8_t msg[] = {
            0x45, 0x92, 0x7E, 0x32, 0xDD, 0xF8, 0x01, 0xCA,
            0xF3, 0x5E, 0x18, 0xE7, 0xB5, 0x07, 0x8B, 0x7F,
            0x54, 0x35, 0x27, 0x82, 0x12, 0xEC, 0x6B, 0xB9,
            0x9D, 0xF8, 0x84, 0xF4, 0x9B, 0x32, 0x7C, 0x64,
            0x86, 0xFE, 0xAE, 0x46, 0xBA, 0x18, 0x7D, 0xC1,
            0xCC, 0x91, 0x45, 0x12, 0x1E, 0x14, 0x92, 0xE6,
            0xB0, 0x6E, 0x90, 0x07, 0x39, 0x4D, 0xC3, 0x3B,
